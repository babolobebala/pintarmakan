...
import { prepareDatasetTableRecordImport } from '#server/utils/dataset-table-record-import'
...
export default defineEventHandler(async (event) => {
  ...
  return prepareDatasetTableRecordImport(session.user, { datasetId, periodDate, file })
