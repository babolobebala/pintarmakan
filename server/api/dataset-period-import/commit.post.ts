...
import { commitDatasetPeriodRecordImport } from '#server/utils/dataset-record-import'
...
export default defineEventHandler(async (event) => {
  ...
  return commitDatasetPeriodRecordImport(session.user, { datasetId, periodDate, file })
})
